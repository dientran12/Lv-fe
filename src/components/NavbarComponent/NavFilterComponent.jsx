                    ...
                    {isMobile ? (
                        <MDBDropdown>
                            ...
                            <MDBDropdownMenu>
                                ...
                                <MDBDropdownItem style={{ whiteSpace: 'nowrap' }} link>Top Sales</MDBDropdownItem>
                        ...
                        <>
                            <div style={{ fontSize: 14, whiteSpace: 'nowrap' }}>Sort by: </div>
                            <div className="name-filter px-3 py-1 ms-1" >Popular</div>
                            <div className="name-filter px-3 py-1">Latest</div>
                            <div className="name-filter px-3 py-1" style={{ whiteSpace: 'nowrap' }} >Top Sales</div>
